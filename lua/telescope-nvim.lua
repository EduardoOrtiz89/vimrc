...
vim.api.nvim_set_keymap("n", "gD", [[<Cmd>lua require('telescope.builtin').lsp_document_diagnostics()<CR>]], opt)
vim.api.nvim_set_keymap("n", "gi", [[<Cmd>lua require('telescope.builtin').lsp_implementations(require('telescope.themes').get_dropdown({}))<CR>]], opt)
vim.api.nvim_set_keymap("n", "gd", [[<Cmd>lua require('telescope.builtin').lsp_definitions(require('telescope.themes').get_dropdown({}))<CR>]], opt)
vim.api.nvim_set_keymap("n", "gr", [[<Cmd>lua require('telescope.builtin').lsp_references(require('telescope.themes').get_dropdown({layout_config = {width = 0.99}}))<CR>]], opt)
